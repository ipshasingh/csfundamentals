...
from PySide6.QtWidgets import (
    ...
    QAbstractItemView, QComboBox, QSpinBox, QSizePolicy
)
...
class HypercubeVisualizer(QMainWindow):
    ...
    def create_experiments_page(self):
        ...
        subtitle = QLabel(
            "Measure search quality and efficiency as the hypercube grows."
        )
        ...
        self.experiment_summary = QLabel(
            "Ready to run"
        )
    ...
    def run_experiments(self):
        ...
        for n in range(minimum, maximum + 1):
            ...
            bfs_path, bfs_visited, _ = bfs_with_events(
                graph, start_state, goal_state
            )
            dfs_path, dfs_visited, _ = dfs_with_events(
                graph, start_state, goal_state
            )
        ...
        self.experiment_summary.setText(
            f"{total_rows} dimensions • "
            f"largest space: {largest['states']:,} states"
        )
